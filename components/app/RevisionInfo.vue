...
<template>
  <div
    class="flex items-center justify-between text-base font-medium text-gray-900 dark:text-white">
    <div class="flex items-center space-x-4">
      <AppRevisionLabel
        :revision="myProps.revision"
        :status="myProps.status"></AppRevisionLabel>
      <span class="text-gray-700 dark:text-gray-200"
        ><slot>{{ statusDisplay }}</slot></span
      >
    </div>
    <div class="flex items-center space-x-4">

...
module.exports = class Store {
  ...
  async getEntityByTag(tenant, tag) {
    ...
    const result = await client.query(q.Call("get-entity-by-tag", tenant, tag))
  ...
  async getEntities(tenant) {
    ...
    const result = await client.query(q.Call("get-entities", tenant))
  ...
  async getEntityById(id) {
    ...
    const result = await client.query(q.Call("get-entity-by-ref", id))
  ...
  async getEntityByTagAndRevision(tenant, tag, revision) {
    ...
    const result = await client.query(
      q.Call("get-entity-by-tag-and-revision", tenant, tag, revision)
    )
  ...
  async getEntityByRevisionRef(id) {
    ...
    const result = await client.query(q.Call("get-entity-by-revisionref", id))
  ...
  async deleteEntityRevision(id) {
    ...
    const result = await client.query(q.Call("delete-entity-revision", id))

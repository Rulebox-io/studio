...
module.exports = class RuleStore {
  ...
  async getRuleSetByTag(tenant, tag) {
    ...
    const result = await client.query(q.Call("get-ruleset-by-tag", tenant, tag))
  ...
  async getRuleSets(tenant) {
    ...
    const result = await client.query(q.Call("get-rulesets", tenant))
  ...
  async getRulesetById(id) {
    ...
    const result = await client.query(q.Call("get-ruleset-by-ref", id))
  ...
  async getRuleSetByTagAndRevision(tenant, tag, revision) {
    ...
    const result = await client.query(
      q.Call("get-ruleset-by-tag-and-revision", tenant, tag, revision)
    )
  ...
  async getRuleSetByRevisionRef(id) {
    ...
    const result = await client.query(q.Call("get-ruleset-by-revisionref", id))
  ...
  async deleteRuleSetRevision(id) {
    ...
    const result = await client.query(q.Call("delete-ruleset-revision", id))
